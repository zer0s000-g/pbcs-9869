...
> [!note]
> This is specifically a guide for upgrading PBCS Doc 9869 Knowledge Base to a more recent update. If you are coming from Quartz 3, check out the [[migrating from Quartz 3|migration guide]] for more info.
