...
## Short definition
RSP is the surveillance performance specification used to state the surveillance capability needed by an ATM operation. It covers surveillance data delivery time, continuity, availability, integrity, monitoring/alerting, and related safety requirements.
