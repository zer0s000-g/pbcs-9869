...
## Short definition
RCP is the communication performance specification used to state the communication capability needed by an ATM operation. It covers communication transaction time, continuity, availability, integrity, monitoring/alerting, and related safety requirements.
